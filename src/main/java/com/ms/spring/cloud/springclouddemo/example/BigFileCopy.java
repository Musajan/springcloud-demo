 ...
 * @Author: Sherlock
 * @Description:
 * @Date: Created in 16:40 2018/7/20
 * @Modified By:
 */
...
public class BigFileCopy {
    ...
    public BigFileCopy(String fileName, int arraySize) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        BigFileCopy reader = new BigFileCopy("/home/zfh/movie.mkv", 65536);
